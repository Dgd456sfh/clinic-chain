        ...
        <div className="mx-auto flex max-w-6xl items-center gap-4 px-6 py-5">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              View the information entered by the receptionist.
            </p>
          </div>
        </div>
      </header>
        ...
        <div className="rounded-3xl border border-sky-100 bg-white p-7 shadow-sm md:p-10">
          ...
          <div className="mb-7">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Enter your unique Patient ID to view all information saved
              by the clinic.
            </p>
          </div>
          ...
          >
            ...
            >
              {loading ? "Loading..." : "View My Record"}
            </button>
          </form>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-xs text-slate-500">
                            Uploaded by the clinic receptionist
                          </p>
                        </div>
                      </div>
